...
**Note on query time ranges:** the identical attack sequence is replayed in this environment on four separate calendar dates (2026-07-29, 2026-07-30, 2026-08-14, 2026-08-17), each time at the same times-of-day. Every query below is scoped with `TimeGenerated between (datetime(2026-07-29) .. datetime(2026-08-18))` to reliably capture all four replays regardless of which one your portal session lands on — narrow this to a single date if you only need one instance of the evidence.
